"""
Django settings for divinemak project.
...
SECRET_KEY = 'django-insecure-)+gfdm%v5rgm6oap5drxr0(%y6)1od&0n^@whr-px1ctr6%v84'
...
WSGI_APPLICATION = 'divinemak.wsgi.application'
