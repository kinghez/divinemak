  ...
  function bwsplit_text() {
    setTimeout(function () {
      var splitTextElements = $(
        ".sec-title__title, .sec-title__tagline, .sec-title-two__title, .sec-title-two__tagline, .sec-title-three__title, .page-header__title, .bw-split-in-fade, .contact-area__title, .bw-split-in-scale"
      );
